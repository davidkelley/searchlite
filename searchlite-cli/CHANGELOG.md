...
## [0.1.11](https://github.com/davidkelley/searchlite/compare/searchlite-cli-v0.1.10...searchlite-cli-v0.1.11) - 2026-04-23

### Fixed

- *(cli)* stream add/delete input instead of loading whole file (BUG-017) ([#235](https://github.com/davidkelley/searchlite/pull/235))
