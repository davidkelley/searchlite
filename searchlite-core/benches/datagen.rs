...
use searchlite_core::api::types::{
  Document, KeywordField, NumericField, Schema, TextField,
};
...
const VOCABULARY: &[&str] = &[
  ...
  "engine", "index", "query", "document", "field", "term", "score", "result",
  "filter", "aggregate", "bucket", "range", "histogram", "keyword", "text",
  "numeric", "nested", "boolean", "match", "phrase", "prefix", "wildcard",
  "fuzzy", "highlight", "suggest", "complete", "analysis", "tokenize", "stem",
  "normalize", "segment", "commit", "merge", "compact", "reader", "writer",
  "schema", "mapping", "setting", "cluster", "node", "shard", "replica",
  "primary", "backup", "restore", "snapshot", "monitor", "health", "status",
  "performance", "benchmark", "throughput", "latency", "memory", "disk",
  "network", "compute", "storage", "cache", "buffer", "queue", "stream",
  "batch", "bulk", "scroll", "page", "sort", "order", "ascending", "descend",
  "limit", "offset", "cursor", "token", "session", "context", "scope",
  "global", "local", "remote", "distributed", "parallel", "concurrent",
  "async", "sync", "block", "release", "acquire", "lock", "atomic", "fence",
  "barrier", "channel", "message", "signal", "event", "handler", "callback",
  "closure", "iterator", "collect", "map", "reduce", "fold", "scan", "chain",
  "zip", "enumerate", "take", "skip", "window", "chunk", "split", "join",
  "format", "parse", "serialize", "encode", "decode", "compress", "extract",
  "transform", "convert", "validate", "verify", "check", "test", "assert",
  "expect", "require", "ensure", "guarantee", "promise", "future", "await",
  "spawn", "task", "thread", "process", "system", "kernel", "driver",
  "module", "package", "crate", "library", "framework", "platform", "layer",
  "stack", "heap", "pool", "arena", "allocator", "garbage", "collect",
  "reference", "pointer", "slice", "array", "vector", "list", "tree",
  "graph", "table", "entry", "record", "row", "column", "cell", "value",
  "data", "information", "knowledge", "insight", "report", "summary",
  "detail", "overview", "review", "update", "create", "delete", "modify",
  "insert", "remove", "append", "prepend", "replace", "swap", "rotate",
  "shuffle", "sample", "random", "seed", "generate", "produce", "consume",
  "publish", "subscribe", "notify", "observe", "watch", "listen", "respond",
  "accept", "reject", "approve", "deny", "grant", "revoke", "allow",
];
...
const CATEGORIES: &[&str] = &[
  ...
  "health", "beauty", "grocery", "garden", "tools", "music", "movies",
  "software", "hardware", "furniture", "jewelry", "shoes", "kitchen",
  "office", "outdoors", "pets", "baby", "crafts", "industrial", "luggage",
  "watches", "cameras", "computers", "phones", "tablets", "gaming",
  "fitness", "cycling", "running", "swimming", "hiking", "camping",
  "fishing", "hunting", "cooking", "baking", "brewing", "sewing",
  "painting", "drawing", "writing", "reading", "travel",
];
