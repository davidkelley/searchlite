...
ssize_t searchlite_search(IndexHandle* handle, const char* query, size_t limit, const char* cursor, const char* aggs_json, size_t aggs_len, char* out_json_buf, size_t buf_cap);
